package com.hochreiter.makeiteasy.tests;

import com.hochreiter.makeiteasy.Donor;
...
import static com.hochreiter.makeiteasy.MakeItEasy.from;
import static com.hochreiter.makeiteasy.MakeItEasy.fromRepeating;
...
public class SequenceTests {
    ...
    public void sequenceFromCollection() {
        Donor<String> names = from(new TreeSet<String>(asList(
